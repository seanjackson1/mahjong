...
public class SeanJackson3 implements Strategy {
    ...
    public Tile discardHiddenTile(int score) {
        ...
        int bestSuit = Math.max(Math.max(numDots, numBamboo), numCharacters);
        ...
        for (int i = 0; i < possibilities.size(); i++) {
             ...
             * To-do:
             * 
             * Assess cards to discard, and discard those with the least in discard
             * 
             */
            ...
            if (possibilities.get(i).getSuit() == bestSuit)
                points[i] += 20;
