...
public class Marsha2 implements Strategy {
    private Table table;
    ...
    public boolean declaresWin(Tile discardedTile, int score) {
        return true; // Marsha Mahjong never declares a win.
    }

    public boolean declaresTriple(Tile discardedTile) {
        return true; // Marsha Mahjong never declares a triple.
    }

    public Tile declaresRun(Tile discardedTile, Tile[] startingTiles) {
        return startingTiles[0]; // Marsha Mahjong never declares a run.
    }
